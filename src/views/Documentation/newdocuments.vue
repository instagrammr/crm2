        ...
        <div class="ion-page" id="main-content">
          <ion-header>
            <ion-toolbar>
              ...
              <ion-title>New Documents</ion-title>
              ...
              <ion-content>
                <div class="form">
                  ...
                  <ion-input v-model="course" label="course" type="text" labelPlacement="floating" fill="solid"
                    class="form-input"></ion-input>
                  <!-- <ion-select v-model="priorityId" label="Status" labelPlacement="floating" fill="solid" class="form-select">
...
export default defineComponent({
  ...
  methods: {
    ...
    //   const payload = {
    //     id: lead.id,
    //     applicatonAssignId: lead.applicatonAssignId,
    //   };
    //   try {
    //     await this.update_lead(payload);
