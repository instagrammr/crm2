<template>
          ...
          <div class="ion-page" id="main-content">
            <ion-header>
              <ion-toolbar>
                ...
                <ion-title>Document Status</ion-title>
                  ...
                  <ion-card-content>
                    <div class="lead-header">
                      <div class="lead-info">
                        ...
                        <div class="info-row">
                          <ion-select v-model="lead.documentStatusId" label="Status" labelPlacement="floating" fill="solid"
  ...
  export default defineComponent({
    ...
    computed: {
      ...mapState('document', ['totalLeadListId', 'totaltodayLeadCount', 'totalremarkListId', 'totalDocumentStatusList']),
    ...
    methods: {
      ...mapActions('document', ['fetchtotalLeadlistId', 'fetchtotalstatuslist', 'update_lead', 'delete_leads',
      'fetchtotalremarkListId', 'fetchtotaltodayLeadCount', 'fetchtotalDocuumentstatuslist'
    ]),
      ...mapActions('counsiller', ['FETCH_DOCUMENTS']),
      async updateLeadStatus(lead) {
      const payload = {
        id: lead.id,
        documentStatusId: lead.documentStatusId,
      };
      try {
