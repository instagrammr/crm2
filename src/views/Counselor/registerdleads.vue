        ...
        <div class="ion-page" id="main-content">
          <ion-header>
            <ion-toolbar class="header-toolbar">
              ...
              <ion-title class="page-title">Registered Leads</ion-title>
          ...
          <ion-content>
            ...
            <div class="leads-list" v-if="totalregisteredListId && totalregisteredListId.rows">
              <ion-list>
                <ion-item-sliding v-for="lead in filteredLeads()" :key="lead.id" class="animate-fade-in">
                  <ion-item>
                    <ion-avatar slot="start">
                      <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgVab_K3tL2c6H6LakvK3aUZ-pKZMDM96v6g&s"
              ...
              <ion-content>
                <form class="update-form">
                  ...
                  <ion-input v-model="course" label="course" type="text" labelPlacement="floating" fill="solid"
                    class="form-input"></ion-input>
                  <ion-select v-model="priorityId" label="Status" labelPlacement="floating" fill="solid"
                    class="form-select">
...
import {
  ...
  warningOutline, notificationsOutline
} from 'ionicons/icons';
...
export default defineComponent({
  ...
  components: {
    ...
    IonItem, IonSelect, IonSelectOption, IonLabel, IonBadge,
     IonItemOption, IonItemOptions, IonItemSliding, IonList, IonAvatar
  },
  data() {
    return {
  ...
  computed: {
    ...mapState('counsiller', ['totalregisteredListId', 'totalLeadCount', 'totalFollowupCount', 'totalRegisteredCount',
  ...
  methods: {
    ...mapActions('counsiller', ['fetchtotalregisteredlistId', 'fetchtotalleadCount', 'fetchtotalfollowupCount', 'fetchtotaldropedCount',
      'fetchtotalregisteredCount', 'fetchtotalCounsillerlist', 'update_lead', 'delete_leads',
    ...
    filteredLeads() {
      if (!this.totalregisteredListId?.rows) return [];

      const searchLower = this.searchQuery?.toLowerCase() || ''; // Handle empty or undefined searchQuery
      return this.totalregisteredListId.rows.filter(lead => {
        return (
