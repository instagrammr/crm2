        ...
        <div class="ion-page" id="main-content">
          <ion-header>
            <ion-toolbar class="header-toolbar">
              ...
              <ion-buttons slot="end">
                ...
                <ion-searchbar v-model="searchQuery" :placeholder="placeholder" class="custom-searchbar"
          ...
          <ion-content>
            ...
            <div class="leads-list" v-if="totalLeadListId && totalLeadListId.rows">
              <ion-list>
                <ion-item-sliding v-for="lead in filteredLeads()" :key="lead.id">
                  <ion-item>
                  ...
                  <ion-item-options side="end">
                    ...
                    <ion-item-option color="danger" @click="handledelete(lead)">
...
import {
  ...
  warningOutline, logoWhatsapp, notificationsOutline,
...
export default defineComponent({
  ...
  components: {
    ...
    IonItem, IonSelect, IonSelectOption, IonLabel, IonItemOption,
    IonItemOptions, IonList, IonAvatar,
    IonItemSliding, IonBadge,
  },
  data() {
    return {
      ...
      trash, chevronBackOutline, trendingUpOutline, flashOutline,
      personCircleOutline, trendingDownOutline, saveOutline, closeOutline,
      warningOutline, logoWhatsapp, notificationsOutline, checkmarkCircleOutline
    };
  },
  computed: {
