<template>
  ...
  export default defineComponent({
    ...
    computed: {
    ...mapState('addLead', ['totalfollowupListId', 'totalfollowupCount', 'totalLeadCount', 'totalcancelledCount']),
     },
     methods: {
      ...mapActions('addLead', ['fetchtotalfollowuplistId', 'fetchtotalcancelledCount', 'fetchtotalleadCount', 'fetchtotalfollowupCount']),
        async fetchleadData() {
