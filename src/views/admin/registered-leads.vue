<template>
        ...
        <div class="ion-page" id="main-content">
          <ion-header>
            <ion-toolbar>
              ...
              <ion-title>Registered Leads</ion-title>
          ...
          <ion-grid class="stats-grid">
            ...
            <!-- Student Info Card -->
            <div v-if="totalregisteredListId && totalregisteredListId.rows">
              <ion-card class="student-info-card" v-for="lead in totalregisteredListId.rows" :key="lead.id">
                <ion-card-content>
  ...
  export default defineComponent({
    ...
    computed: {
    ...mapState('addLead', ['totalregisteredListId', 'totalregisteredCount', 'totalLeadCount']),
     },
     methods: {
        ...mapActions('addLead', ['fetchtotalregisteredlistId', 'fetchtotalregisteredCount', 'fetchtotalleadCount',]),
        async fetchleadData() {
