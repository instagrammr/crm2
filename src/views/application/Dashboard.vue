        ...
        <div class="ion-page" id="main-content">
          <ion-header>
            <ion-toolbar class="header-toolbar">
              ...
              <ion-title class="main-title">Application Dashboard</ion-title>
...
export default defineComponent({
  ...
  computed: {
    ...mapState('application', [ 'totalleadDayMonthListId', 'totalconvertedLeadCount',
  ...
  methods: {
    ...mapActions('application', ['fetchtotalleadCount', 'fetchtotalLeadDayMonthlistId', 'fetchtotaltodayLeadCount',
      'fetchtotalleadCount',
