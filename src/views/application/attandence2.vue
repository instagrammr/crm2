...
export default defineComponent({
  ...
  computed: {
    ...
    attendanceRecords() {
      ...
      // console.log("Mapped attendance records:", records);
      return records;
    },
  },

  methods: {
    ...mapActions('attendance', ['fetchtotalAttendancelistId', 'fetchtotalCurrentAbsentCount', 'fetchtotalCurrentPresentCount']),
