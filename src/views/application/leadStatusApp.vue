<template>
  ...
  export default defineComponent({
    ...
    computed: {
      ...mapState('application', ['totalLeadListId', 'totaltodayLeadCount', 'totalremarkListId']),
    ...
    methods: {
      ...mapActions('application', ['fetchtotalLeadlistId','fetchtotalapplicationlist', 'fetchtotalstatuslist', 'update_lead', 'delete_leads',
