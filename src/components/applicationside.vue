...
export default {
  ...
  setup() {
    ...
    const appPages = [
      {
        title: 'Dashboard',
        url:  { name: 'ADashbord', params: { id: userId.value } },
        icon: gridOutline
      },
      {
        title: 'New application',
        url: { name: 'NewApplications', params: { id: userId.value } },
        icon: documentTextOutline
      },
       {
        title: 'Application',
        url: { name: 'TotalApplications', params: { id: userId.value } },
        icon: libraryOutline
      },
      {
        title: 'Follow-up application',
        url:{ name: 'FollowupApplicatio', params: { id: userId.value } },
        icon: timeOutline
      },
     
      {
        title: 'Dropped application',
        url: { name: 'DropedApplications', params: { id: userId.value } },
        icon: trashOutline
      },
      {
        title: 'Registerd Applications',
        url: { name: 'registeredApplications', params: { id: userId.value } },
