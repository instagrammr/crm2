...
import { IonMenu, IonContent, IonList, IonMenuToggle, IonItem, IonIcon, IonLabel, IonSpinner} from '@ionic/vue';
...
export default {
  name: 'SideMenu',
  components: {
    IonMenu, IonContent, IonList, IonMenuToggle, IonItem, IonIcon, IonLabel, IonSpinner  
  },
  setup() {
    ...
    const appPages = [
      { title: 'Dashboard', url: { name: 'leaddashbord', params: { id: userId.value } }, icon: gridOutline },
      { title: 'leads', url: { name: 'viewlead', params: { id: userId.value } }, icon: calendarOutline },
      ...
      // attendanceAdd
    //  leaverequest4
      // { title: 'Student Status', url: { name: 'studentStatusAdd' }, icon: calendarOutline },
    ];
